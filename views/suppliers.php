    ...
    <main class="w-screen">
        ...
        <section class="mx-auto container my-10">
            ...
            <div>
                ...
                <form action="../app/actions/new_supplier.php" method="post" class="mb-16">
                    <div class="grid grid-cols-3 gap-6">
                        <label class="flex flex-col mb-4 text-blue-500 font-regular">
                            Nome
                            <input name="supplier_name" type="text" placeholder="ex: Apple Computer"
                                class="w-full outline-0 focus:border-blue-500 border-2 border-gray-300 py-2 px-4 rounded-md">
                        </label>
                        <label class="flex flex-col mb-4 text-blue-500 font-regular">
                            Email
                            <input name="supplier_email" type="email" placeholder="ex: suporte@gmail.com"
                            class="w-full outline-0 focus:border-blue-500 border-2 border-gray-300 py-2 px-4 rounded-md">
                        </label>
                        <label class="flex flex-col mb-4 text-blue-500 font-regular">
                            Telefone de Contato
                            <input name="supplier_telephone" type="text" placeholder="ex: 19999179999"
                            class="w-full outline-0 focus:border-blue-500 border-2 border-gray-300 py-2 px-4 rounded-md">
                        </label>
                    </div>
                        ...
                        <tbody>
                            <?php foreach($suppliers as $p): ?>
                                <tr class="border-2 even:bg-gray-200">
                                    <td class="py-2 px-4 text-sm"><?= $p->stakeholder_id; ?></td>
                                    <td class="py-2 px-4 text-sm"><?= $p->created_at; ?></td>
                                    <td class="py-2 px-4 text-sm"><?= $p->name; ?></td>
                                    <td class="py-2 px-4 text-sm"><?= $p->email; ?></td>
                                    <td class="py-2 px-4 text-sm"><?= $p->contact_number; ?></td>
                                    ...
                                    <td class="p-4 flex items-center justify-center gap-2">
                                        ...
                                        <a href="<?= BASE_URL ?>/app/actions/remove_supplier.php?supplier_id=<?=$p->stakeholder_id?>" class="bg-red-500 py-2 px-4 text-white rounded-md">Excluir</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
